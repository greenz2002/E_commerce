...
public enum ErrorCode {
    ...
    USER_NOT_EXITS(1006,"User not exits",HttpStatus.NOT_FOUND),
    ...
    USERID_EXITS(1006,"User id exits",HttpStatus.BAD_REQUEST),
    USER_EXITS(1001,"User exits",HttpStatus.UNAUTHORIZED);
